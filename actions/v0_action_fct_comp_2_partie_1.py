...
class AppFctComp2Partie1(QDialog):
    ...
    def __init__(self, data:sqlite3.Connection):
        ...
        possibleValues = cursor.execute("select distinct categorieEp from LesEpreuves")

        for categorie in possibleValues:
            self.ui.lineEdit_fct_comp_2.addItem(categorie[0])

    # Fonction de mise à jour de l'affichage
    def refreshResult(self):
        # 1.2 : fonction à modifier pour remplacer la zone de saisie par une liste de valeurs issues de la BD une
